...
const STEPS = [
  ...
  { number: "03", title: "Permanent Bonding", description: "Your final veneers are bonded — a permanent, natural-looking result designed to last 10–20 years with proper care." },
];
...
const FAQ = [
  ...
  { q: "How long do porcelain veneers last?", a: "With proper care, 10–20 years. Porcelain is stain-resistant and extremely durable. Avoid biting hard objects (ice, pens) and attend regular check-ups." },
  { q: "How many veneers do I need?", a: "This depends on your smile goals. Some patients do 6–8 veneers for a full visible smile. Others address just 2–4. Dr. Rana will walk you through options during the digital design consultation." },
];
      ...
      <div className="container-main max-w-3xl mx-auto">
        <AnimatedSection>
          ...
          <div className="flex flex-wrap gap-2">
            {["Custom Porcelain", "Digitally Designed", "Natural Translucency", "2 Visits", "Stain Resistant", "10–20 Year Lifespan"].map((tag) => (
