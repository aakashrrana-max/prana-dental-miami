...
const BlogAllOn4Cost = () => (
  <>
    <SEO
      title="All-on-4 Cost in Miami 2025 to 2026 | Honest Pricing Guide | Prana Dental"
      ...
      <div className="container-main max-w-3xl px-6 md:px-12">
        <AnimatedSection>
          ...
          <div className="space-y-5 font-body text-prana-charcoal/70 leading-[1.8] text-[15px]">
            ...
            <p>At many high-end clinics in Brickell, Coral Gables, and Miami Beach, prices of $25,000 to $30,000 per arch are common - and that does not always include the final zirconia restoration.</p>
            ...
            <ul className="list-none space-y-3 ml-0">
              {["CT scan and digital treatment planning", "All implants (typically 4 to 6 per arch)", "Implant surgery with sedation", "Same-day provisional teeth where clinically appropriate", "Final zirconia bridge", "All follow-up visits and adjustments"].map((item, i) => (
                <li key={i} className="flex items-start gap-3"><span className="text-prana-terra">✓</span> {item}</li>
              ))}
            </ul>
