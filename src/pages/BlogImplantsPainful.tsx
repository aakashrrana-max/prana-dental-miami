      ...
      <div className="container-main max-w-3xl px-6 md:px-12">
        <AnimatedSection>
          ...
          <div className="space-y-5 font-body text-prana-charcoal/70 leading-[1.8] text-[15px]">
            ...
            <p>Some soreness and swelling in the first 24 to 72 hours is normal. This is part of your body's natural healing response. Most patients manage it comfortably with over-the-counter pain medication like ibuprofen.</p>
